...
#   describe '"appuser" mysql user is created for localhost and any host' do
#     describe command(
#       'echo \'SELECT User, Host FROM mysql.user\' | mysql --user=root'\
#       '--password=rootpass'
#     ) do
...
#     describe command(
#       "echo \"SHOW DATABASES LIKE 'app_test'\" | mysql --user=appuser"\
#       "--password=apppass"
#     ) do
...
#     describe command(
#       'echo \'USE app_test; SELECT * FROM app_test\' | mysql --user=appuser'\
#       '--password=apppass'
#     ) do
...
#     describe command(
#       "echo \"DROP DATABASE IF EXISTS blah; CREATE DATABASE blah; SHOW"\
#       "DATABASES LIKE 'blah'\" | mysql --user=root --password=rootpass"
#     ) do
...
#   let(:default_tags) do
#     MachineTag::Set.new(
#       JSON.parse(IO.read('/vagrant/cache_dir/machine_tag_cache/#{host_name}'\
#                          '/tags.json'))
#     )
#   end
#
